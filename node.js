...
// is all given numbers divisible by 5?
...
console.log("Is first number greater than last number? : " +  isfirstgreaterthanlast + "\n");
// Subtract the first number from the second number
// Multiply the result by the third number.
// Find the remainder of dividing the result by the fourth number.
const achain = ((n2 - n1) * n3) % n4;
console.log("arithmetic chain reminder is : " + achain + "\n");
